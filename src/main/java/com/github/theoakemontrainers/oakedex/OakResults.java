...
public class OakResults extends JFrame implements ActionListener {
	...
	public OakResults() {
		...
		frame
				.add(new JScrollPane(middle, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
						JScrollPane.HORIZONTAL_SCROLLBAR_NEVER));
		
		// These are just examples. Add more if you want the scroll
		// functionality
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() instanceof JButton) // This is called when you hit
																						// one of the resulting pokemon
																						// stuff
		{
			JButton clicked = (JButton) ae.getSource(); // gets the button that
																									// you hit
			String clickedText = clicked.getText(); // gets the text in the
																							// button (the ID and name of
																							// the pokemon)
	...
	public void addToResults(String pIDAndName) {
		JPanel resultPanel = new JPanel();
		JButton btnResult = new JButton(pIDAndName);
