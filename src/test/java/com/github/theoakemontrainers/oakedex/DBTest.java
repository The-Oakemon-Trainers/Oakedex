...
public class DBTest {
  public static void main(String[] args) {
    ...
    System.out.println();
    System.out.print("Selecting language 9: ");
    
    // test getResult();
    System.out.println(
        conn.getResult("select identifier from languages where id = 9;"));
    
    // test getRow()
    HashMap<String, Object> row = conn
        .getRow("select * from languages where id = 9");
    ...
    HashMap<Object, Object> map = conn.getMap(
        "select local_language_id, name from language_names where language_id = 9");
